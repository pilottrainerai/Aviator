...
describe("mock scorer", () => {
  it("scores a perfect run at 100", () => {
    const events: ScenarioEvent[] = [
      ...
      { kind: "STEP", stepId: "oeb_check",              tMs: 64000, source: "pilot" },
      { kind: "STEP", stepId: "wx_request",            tMs: 66000, source: "pilot" },
      { kind: "STEP", stepId: "ldg_perf",              tMs: 70000, source: "pilot" },
      { kind: "STEP", stepId: "fordec",                tMs: 73000, source: "pilot" },
      { kind: "STEP", stepId: "fmgc_prep",             tMs: 75000, source: "pilot" },
      { kind: "STEP", stepId: "nis_brief",             tMs: 77000, source: "pilot" },
      { kind: "STEP", stepId: "pax_pa",                tMs: 79000, source: "pilot" },
      { kind: "STEP", stepId: "go_around_review",      tMs: 81000, source: "pilot" },
      { kind: "STEP", stepId: "atc_emergency_services",tMs: 83000, source: "pilot" },
      { kind: "STEP", stepId: "approach_brief",        tMs: 85000, source: "pilot" },
      { kind: "STEP", stepId: "approach_prep",         tMs: 87000, source: "pilot" },
      { kind: "STEP", stepId: "approach_cl",           tMs: 89000, source: "pilot" },
      { kind: "STEP", stepId: "landing_cl",            tMs: 91000, source: "pilot" },
      { kind: "DECISION", value: "LAND_ASAP",          tMs: 95000, source: "pilot" },
    ];
