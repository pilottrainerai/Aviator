...
PANEL      = "gpws"                      # public/models/<PANEL>_panel.glb + <PANEL>_face.png
FACE_OBJ   = "Plane"                 # the object carrying the painted face/decal sheet
FACE_MAT   = "hydraulic decals"          # its un-exportable MIX_SHADER material (from 01_inspect.py)
BAKE_W, BAKE_H = 4096, 1304              # match the face UV aspect (~3.74:1 from inspect)
