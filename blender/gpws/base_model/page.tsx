...
const KEY = "gpwsTune.v10"; // bump on default changes to discard stale saved tunes
          ...
          {GPWS_BTN_ORDER.map((key) => {
            ...
            return (
              <div key={key} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                ...
                {chip(!!st.on, GPWS_ON_LABEL[key], GPWS_ON_LABEL[key] === "ON" ? "#7ec6ff" : "#f3f6fa", () => toggleLight(key, "on"))}
              </div>
            );
          })}
