...
PANEL      = "eng_start"                 # public/models/<PANEL>_panel.glb + <PANEL>_face.png
FACE_OBJ   = "Curve.001"                 # the object carrying the painted face/decal sheet
FACE_MAT   = "DECALS"                    # its un-exportable material (from 01_inspect.py)
BAKE_W, BAKE_H = 4096, 860               # match the face UV aspect (inspect output)
